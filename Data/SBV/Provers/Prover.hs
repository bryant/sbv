...
module Data.SBV.Provers.Prover (
       ...
       , boolector, cvc4, yices, z3, mathSAT, abc, stp, defaultSMTCfg
...
import qualified Data.SBV.Provers.STP        as STP
...
-- | Default configuration for the STP SMT solver.
stp :: SMTConfig
stp = mkConfig STP.stp True []
